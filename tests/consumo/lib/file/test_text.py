...
def test_calculate_reading_time(word_count: int, words_per_minute: int) -> None:
    actual_reading_time: Second = calculate_reading_time(word_count, words_per_minute)
    expected_reading_time: Second = 60
...
def test_calculate_consumption_time() -> None:
    ...
    actual_consumption_time: Second = calculate_consumption_time(container)
    expected_consumption_time: Second = 99
